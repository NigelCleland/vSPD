...
* Implement the Pole 3 substitutes
* See if this works properly!
* Define new northward and southward Pole 3 branch elements
$onmulti
set i_Branch /'BEN_HAY3.1','HAY_BEN3.1'/;

* Set up the connectivity to connect pole 3 to the same terminal nodes as pole 2
i_TradePeriodBranchDefn(i_TradePeriod,'BEN_HAY3.1',i_FromBus,i_ToBus) $ i_TradePeriodBranchDefn(i_TradePeriod,'BEN_HAY2.1',i_FromBus,i_ToBus) = yes;
i_TradePeriodBranchDefn(i_TradePeriod,'HAY_BEN3.1',i_FromBus,i_ToBus) $ i_TradePeriodBranchDefn(i_TradePeriod,'HAY_BEN2.1',i_FromBus,i_ToBus) = yes;

* Define as an HVDC Branch
i_TradePeriodHVDCBranch(i_TradePeriod,'BEN_HAY3.1') = 1;
i_TradePeriodHVDCBranch(i_TradePeriod,'HAY_BEN3.1') = 1;

* Set up the parameters of Pole 3, use the same as Pole 2.
i_TradePeriodBranchParameter(i_TradePeriod,'BEN_HAY3.1',i_BranchParameter) = i_TradePeriodBranchParameter(i_TradePeriod,'BEN_HAY2.1',i_BranchParameter);
i_TradePeriodBranchParameter(i_TradePeriod,'HAY_BEN3.1',i_BranchParameter) = i_TradePeriodBranchParameter(i_TradePeriod,'HAY_BEN2.1',i_BranchParameter);

* Define the capacity of Pole 3
i_TradePeriodBranchCapacity(i_TradePeriod,'BEN_HAY3.1') = 700;
i_TradePeriodBranchCapacity(i_TradePeriod,'HAY_BEN3.1') = 700;

* Turn Pole 1 off
i_TradePeriodBranchOpenStatus(i_TradePeriod,'BEN_HAY1.1') = 1;
i_TradePeriodBranchOpenStatus(i_TradePeriod,'HAY_BEN1.1') = 1;

* Set the Risk Parameters
i_TradePeriodRiskParameter(i_TradePeriod,i_Island,i_ReserveClass,'DCCE','i_HVDCPoleRampUp') = 474.6;
i_TradePeriodRiskParameter(i_TradePeriod,i_Island,i_ReserveClass,'DCCE','i_FreeReserve') = 0;

* Update the mixed constraint flag for pre 2009
i_UseMixedConstraintRiskOffset = 0
...
*TN - Excel interface codes removed for standalone version ++++++++++++++++++++++++++++++++++++++++++++++++
...
*TN - codes added for standalone version - Default overrides ++++++++++++++++++
i_TradePeriodSolve(i_TradePeriod) = 1;
*i_TradePeriodSolve(i_TradePeriod) $ [(ord(i_TradePeriod) > 20) or (ord(i_TradePeriod) < 15)] = 0;

i_EnergyOfferOvrd(i_TradePeriod,i_Offer,i_TradeBlock,i_EnergyOfferComponent) = 0;
i_OfferParamOvrd(i_TradePeriod,i_Offer,i_OfferParam) = 0;

i_NodeDemandOvrd(i_TradePeriod,i_Node) = 0;
i_IslandDemandOvrd(i_TradePeriod,i_Island) = 0;
